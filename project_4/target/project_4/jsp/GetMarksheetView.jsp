...
<body>
	...
	<center>
		...
		<form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="post">
			...
			<table>
				<label align="left">RollNo :</label>&emsp;
				...
				<th style="position: fixed"><font color="red"
					style="position: relative; left: 154px; top: -23px;"> <%=ServletUtility.getErrorMessage("rollNo", request)%></font></th>
				...
				<table border="1px " style="width: 100%">
					...
					<tr>
						...
						%>
						<th colspan="4"><font color="red">FAIL</font></th>
						<%
							} else {
						%>
						<th colspan="4"><font color="green">PASS</font></th>
						<%
							}
						%>
					</tr>
