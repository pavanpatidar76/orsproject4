...
public class UserModel {
	...
	public long add(UserBean bean) throws DuplicateRecordsException, ApplicationException, SQLException {
        ...
        if (existbean != null) {
            throw new DuplicateRecordsException("Login Id already exists");
        }
	...
	public List search(UserBean bean, int pageNo, int pageSize) {
		...
		try {
			...
			while (rs.next()) {
				...
				list.add(bean);
		      System.out.println("UserModel search sql: "+sql);
			}
			rs.close();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public boolean changePassword(Long id, String oldPassword, String newPassword)
			throws RecordNotFountException, ApplicationException {
...
/* try {
 ...
 if (userData == null) {
     ...
     throw new RecordNotFountException("Email ID does not exists !");
