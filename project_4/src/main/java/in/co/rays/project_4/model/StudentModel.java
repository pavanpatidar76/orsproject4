...
public class StudentModel {
	...
	public long add(StudentBean bean) throws DuplicateRecordsException, ApplicationException, Exception{
		  ...
		  // get College Name
	       ...
	       if (duplicateName != null) {
	            throw new DuplicateRecordsException("Email already exists");
	        }
     ...
     * @throws ApplicationException the application exception
     */
    public void update(StudentBean bean) throws DuplicateRecordsException, ApplicationException{
             ...
             System.out.println("jjjjjjjjjjj..in model update method"+bean.getId());
    	        ...
    	        if (beanExist != null && beanExist.getId() != bean.getId()) {
    	            throw new DuplicateRecordsException("Email Id is already exist");
    	        }
